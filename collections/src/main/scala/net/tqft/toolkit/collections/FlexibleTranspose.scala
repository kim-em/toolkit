...
object FlexibleTranspose {
  ...
  implicit class FlexibleTranspose[A](listOfLists: List[List[A]]) {
  ...
  implicit class FlexibleTransposeIterables[A](iterableOfIterables: Iterable[Iterable[A]]) {
  ...
  implicit class FlexibleTransposeIterators[A](iteratorOfIterators: Iterator[Iterator[A]]) {
