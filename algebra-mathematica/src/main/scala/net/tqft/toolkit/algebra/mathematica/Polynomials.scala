...
object Polynomials {
  implicit def multivariablePolynomialToExpression[A: MathematicaForm, V: MathematicaForm](p: MultivariablePolynomial[A, V]): Expression = {
    ...
    Expression(mf.toMathematicaInputString(p))
  }
  
  implicit def expressionToMultivariablePolynomial[I: IntegerModel](e: Expression): MultivariablePolynomial[I, String] = {
    val integers = implicitly[IntegerModel[I]]
    val polynomials = implicitly[MultivariablePolynomialAlgebra[I, String]]
    val expressions = implicitly[MathematicaExpression[Expression]]

    def expressionToMultivariableMonomial(e: Expression): MultivariablePolynomial[I, String] = {
      e match {
    ...
    def expressionToMonomial(e: Expression): MultivariablePolynomial[I, String] = {
      e match {
