...
class TetravalentDiagramsTest extends FlatSpec with Matchers with IsomorphismMatchers {
  ...
  "byNumberOfVertices" should "find 0 diagrams with 0 boundary points and 2 vertices" in {
    tetravalentDiagrams.byNumberOfVertices(0, Map(VertexType(4, 1) -> 2)).size should equal(0)
  }
  "byNumberOfVertices" should "find 2 diagrams with 0 boundary points and 3 vertices" in {
    //  the two trefoil shadows
    tetravalentDiagrams.byNumberOfVertices(0, Map(VertexType(4, 1) -> 3)).size should equal(2)
  }
  ...
  "byNumberOfVertices" should "find 2 diagrams with 4 boundary points and 2 vertices" in {
    tetravalentDiagrams.byNumberOfVertices(4, Map(VertexType(4, 1) -> 2)).size should equal(2)
  }
  ...
  "byNumberOfVertices" should "find 15 diagrams with 6 boundary points and 2 crossings" in {
    tetravalentDiagrams.byNumberOfVertices(6, Map(VertexType(4, 1) -> 2)).size should equal(15)
  }
